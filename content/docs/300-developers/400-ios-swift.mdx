---
title: iOS / Swift
excerpt: Build your Kinetic app with iOS / Swift
nav_title: iOS / Swift
---
...
- Search "[https://github.com/kinnytips/kinetic-ios-sdk](https://github.com/kinnytips/kinetic-ios-sdk)"
...
Don't have an App Index? Register your app on our Developer Portal so you can get your App Index that allows you to transact with our SDKs.
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <NavCard
    ...
    icon="github"
    link={{ url: 'https://github.com/kinnytips/kinetic-ios-sdk', label: 'Contribute' }}
  />
</div>
...
Once you're ready to code, have a quick look at our [Developer Best Practices](/essentials/best-practices/) where we cover some useful topics that you'll want to keep in mind as you build out your application.

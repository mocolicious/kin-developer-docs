---
title: Unity
excerpt: Build your app with Unity
nav_title: Unity
---
...
Enter the `https://github.com/kinnytips/kinetic-unity-sdk.git` Git URL in the text box and click `Add`.
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  <NavCard
    ...
    icon="github"
    link={{ url: 'https://github.com/kinnytips/kinetic-unity-sdk', label: 'Contribute' }}
  />
</div>

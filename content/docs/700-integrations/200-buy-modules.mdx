...
Here's a lovely [Ramp Android Demo](https://github.com/kinnytips/kin-android-ramp-demo).

And here's an equally lovely [Ramp iOS Demo](https://github.com/kinnytips/kin-ios-ramp-demo).
